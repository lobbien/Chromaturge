...
public class GreenWispParticleEffect extends AbstractGameEffect {


    private static final Texture IMG1 = TextureLoader.getTexture(DefaultMod.makeVfxPath("GreenWispParticle.png"));
    private Texture img;
    private float posx;
    private float posy;
    ...
    public GreenWispParticleEffect(float posx, float posy)
    {
        ...
        scale = 1;
        float y = r.nextFloat();
        this.color = new Color(y * 0.8f, 1.0f , y, 0.6f);
