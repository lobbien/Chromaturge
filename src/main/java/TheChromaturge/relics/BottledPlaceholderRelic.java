...
import TheChromaturge.patches.relics.BottledPlaceholderField;
import TheChromaturge.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static TheChromaturge.DefaultMod.makeRelicOutlinePath;
import static TheChromaturge.DefaultMod.makeRelicPath;
