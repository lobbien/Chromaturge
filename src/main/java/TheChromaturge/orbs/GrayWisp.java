...
import TheChromaturge.vfx.GrayWispParticleEffect;
...
public class GrayWisp extends AbstractWisp {
    ...
    public static final String ORB_ID = DefaultMod.makeID("GrayWisp");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESC = orbString.DESCRIPTION;
    private float vfxTimer = 1.0F;
    private float vfxIntervalMin = 0.5F;
    private float vfxIntervalMax = 0.5F;

    public GrayWisp(int duration) {
        super(duration);
        this.ID = ORB_ID;
    ...
    public AbstractOrb makeCopy() {
        return new GrayWisp(this.baseEvokeAmount);
    }
    ...
    public void updateAnimation() {
        ...
        if (this.vfxTimer < 0.0F) {
            AbstractDungeon.effectList.add(new GrayWispParticleEffect(this.cX, this.cY));
    ...
    public void render(SpriteBatch sb) {
        ...
        DefaultMod.Wispbatch.setColor(new Color(0.5F, 0.5F, 0.5F, 1.0F));
        ...
        DefaultMod.Wispbatch.setColor(new Color(0.8F, 0.8F, 0.8F, 0.4F));
        ...
        DefaultMod.Wispbatch.setColor(new Color(1.0F, 1.0F, 1.0F, 0.6F));
