...
import TheChromaturge.vfx.RedWispParticleEffect;
...
public class RedWisp extends AbstractWisp {
    ...
    public static final String ORB_ID = DefaultMod.makeID("RedWisp");
    ...
    public AbstractOrb makeCopy() {
        return new RedWisp(this.baseEvokeAmount);
    }
    ...
    public void updateAnimation() {
        ...
        if (this.vfxTimer < 0.0F) {
            AbstractDungeon.effectList.add(new RedWispParticleEffect(this.cX, this.cY));
    ...
    public void render(SpriteBatch sb) {
        ...
        DefaultMod.Wispbatch.setColor(new Color(0.8F, 0.0F, 0.0F, 1.0F));
        ...
        DefaultMod.Wispbatch.setColor(new Color(1.0F, 0.5F, 0.2F, 0.4F));
