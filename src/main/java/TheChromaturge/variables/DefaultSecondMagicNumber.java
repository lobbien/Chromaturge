package TheChromaturge.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import TheChromaturge.cards.AbstractDefaultCard;

import static TheChromaturge.DefaultMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "TheChromaturge:" (or, your id) before the name.
    }
